...
class Match
{
     ...
     * @return array
     */
    public static function somethingLike($value): array
    {
     ...
     * @return array
     */
    public static function term($value, string $pattern): array
    {
     ...
     * @return array
     */
    public static function regex($value, string $pattern)
    {
        return self::term($value, $pattern);
    }
     ...
     * @return array
     */
    public static function dateISO8601(string $value = '2013-02-01'): array
    {
        return self::term($value, self::ISO8601_DATE_FORMAT);
    }
     ...
     * @return array
     */
    public static function timeISO8601(string $value = 'T22:44:30.652Z'): array
    {
        return self::term($value, self::ISO8601_TIME_FORMAT);
    }
     ...
     * @return array
     */
    public static function dateTimeISO8601(string $value = '2015-08-06T16:53:10+01:00'): array
    {
        return self::term($value, self::ISO8601_DATETIME_FORMAT);
    }
     ...
     * @return array
     */
    public static function dateTimeWithMillisISO8601(string $value = '2015-08-06T16:53:10.123+01:00'): array
    {
        return self::term($value, self::ISO8601_DATETIME_WITH_MILLIS_FORMAT);
    }
     ...
     * @return array
     */
    public static function timestampRFC3339(string $value = 'Mon, 31 Oct 2016 15:21:41 -0400'): array
    {
        return self::term($value, self::RFC3339_TIMESTAMP_FORMAT);
    }
     ...
     * @return array
     */
    public static function integer(int $int = 13): array
    {
        return self::like($int);
    }
     ...
     * @return array
     */
    public static function decimal(float $float = 13.01): array
    {
        return self::like($float);
    }
     ...
     * @return array
     */
    public static function hexadecimal(string $hex = '3F'): array
    {
        return self::term($hex, self::HEX_FORMAT);
    }
     ...
     * @return array
     */
    public static function uuid(string $uuid = 'ce118b6e-d8e1-11e7-9296-cec278b6b50a'): array
    {
        return self::term($uuid, self::UUID_V4_FORMAT);
    }
     ...
     * @return array
     */
    public static function ipv4Address(string $ip = '127.0.0.13'): array
    {
        return self::term($ip, self::IPV4_FORMAT);
    }
     ...
     * @return array
     */
    public static function ipv6Address(string $ip = '::ffff:192.0.2.128'): array
    {
        return self::term($ip, self::IPV6_FORMAT);
    }
}
